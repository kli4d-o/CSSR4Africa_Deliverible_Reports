...
\item [Version 2.7]~\\
Update {\small \verb+speechEvent+} to include use {\small \verb+speechEvent\recognise_speech_action+} ROS action to trigger speech recognition to run \\
Update {\small \verb+speechEvent+}'s configuration file \\
Update system architecture diagram to show {\small \verb+speechEvent+}'s {\small \verb+speechEvent\recognise_speech_action+} ROS action\\
Clifford Onyonka.\\
08 May 2026.
