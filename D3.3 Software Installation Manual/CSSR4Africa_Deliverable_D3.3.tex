...
\begin{document}
	...
	\section{Setting up the Development Environment}
	{
		...
		\begin{description}
			...
			\item [Version 1.20]~\\
			Updated the text indicating the number of software that have been uploaded in the cssr\_system and unit\_tests directory\\ 
			Updated Figure 5 to include robot localization\\
			Added additional install packages for robot localization and robot navigation to 3.2.2\\
			Re-arranged the names in principal contributors in alphabetical order\\
			Ibrahim Jimoh.\\
			27 October 2025.
