...
%===========================================================================
%======================= D4.3.2 Speech Event - v1.0 ========================
%===========================================================================

\section{D4.3.2 Speech Event - v1.0} 
...
%===========================================================================
%======================= D4.3.2 Speech Event - v1.1 ========================
%===========================================================================


\section{D4.3.2 Speech Event - v1.1}
\subsection{Speech Event} 
%===========================================
\label{subsection:speech_event}
The \textbf{Speech Event v1.1} software was submitted for integration on April 22nd, 2026. The results indicate the software has successfully passed the integration process. 
...
\item[\checkboxChecked] The \textbf{speech\_event} directory has six sub-directories:  {\small \verb+action+}, {\small \verb+config+},   {\small \verb+data+}, {\small \verb+models+}, {\small \verb+src+}, and {\small \verb+srv+}.

\item[\checkboxChecked] The  {\small \verb+action+} directory contains one file, named.

\begin{description}
\item[\checkboxChecked] {\small \verb+recognise_speech.action+}
\end{description}
...
\item[\checkboxChecked] The  {\small \verb+model+} directory contains seven files, named as follows.
\begin{description}
\item[\checkboxChecked] {\small \verb+silero_vad.jit+}
\item[\checkboxChecked] {\small \verb+stt_rw_comformer_transducer_large.nemo+}
\item[\checkboxChecked] {\small \verb+stt_en_conformer_transducer_large.nemo+}
\item[\checkboxChecked] {\small \verb+stt_rw_parakeet-tdt_ctc-110m.nemo+}
\item[\checkboxChecked] {\small \verb+stt_en_parakeet-tdt_ctc-110m.nemo+}
\item[\checkboxChecked] {\small \verb+stt_rw_whisper-large-v3-turbo.pt+}
\item[\checkboxChecked] {\small \verb+stt_en_whisper-large-v3-turbo.pt+}
\end{description} 
...
\item[\checkboxChecked] {\small \verb+speech_event_application.py+}
\item[\checkboxChecked]  {\small \verb+speech_event_implementation.py+}
\item[\checkboxChecked]  {\small \verb+speech_event_gui.py+}
\item[\checkboxChecked]  {\small \verb+speech_event_utils.py+}
\end{description} 


\item[\checkboxChecked] The  {\small \verb+srv+} directory contains one file, named as follows.
\begin{description}
\item[\checkboxChecked] {\small \verb+set_language.srv+}  
\end{description} 
...
This project is funded by the African Engineering and Technology
Network (Afretec) Inclusive Digital Transformation Research Grant
Programme.
...
This program defines the speechEvent ROS node. The speechEvent ROS node
transcribes Kinyarwanda and English speech utterances in an audio
signal published by the soundDetection ROS node on the
/soundDetection/signal ROS topic, and publishes the transcribed text on
the /speechEvent/text ROS topic.
\end{verbatim}}
...
\begin{verbatim}
speechEvent: start-up
speechEvent: subscribed to /soundDetection/signal
speechEvent: /speechEvent/set_language service advertised
speechEvent: transcription language set to English
speechEvent: /speechEvent/recognise_speech_action action server is ready
\end{verbatim}}
...
\item[\checkboxChecked] Unit test instructions are provided in a file named {\small \verb+README.md+} in the  {\small \verb+speech_event+} directory.
...
\item[\checkboxChecked] {\small \verb+speech_event_driver_configuration.ini+}  
\item[\checkboxChecked] {\small \verb+speech_event_test_configuration.ini+}  
\item[\checkboxChecked] The configuration files {\small \verb+speech_event_driver_configuration.ini+} and \\{\small \verb+speech_event_test_configuration.ini+} contain the key-value pairs that set the component parameters.
\item[\checkboxChecked] Each key-value pair is written on a separate line.
\end{description} 
...
\item[\checkboxChecked] The  {\small \verb+launch+} directory contains two files, named as follows.
\begin{description}
\item[\checkboxChecked] {\small \verb+speech_event_test_launch_robot.launch+}
\item[\checkboxChecked] {\small \verb+speech_event_test_launch_test_harness.launch+}
\end{description} 

\item[\checkboxChecked] The  {\small \verb+src+} directory contains five source files, named as follows.
\begin{description}
\item[\checkboxChecked] {\small \verb+speech_event_driver.py+}
\item[\checkboxChecked] {\small \verb+speech_event_test_application.py+}
\item[\checkboxChecked] {\small \verb+speech_event_test_implementation.py+}
\item[\checkboxChecked] {\small \verb+speech_event_test_class.py+}
\item[\checkboxChecked] {\small \verb+speech_event_test_utils.py+}
\end{description} 
...
\item[\checkboxChecked] The {\small \verb+speech_event_test+} directory contains  a {\small \verb+README.md+} file with  instructions on how to run the software.
%{\color{blue}in the case of \verb+unit_tests+ or run the node in the case of \verb+cssr_system+}.
\item[\checkboxChecked] The {\small \verb+speech_event_test+} directory contains  no {\small \verb+CMakeLists.txt+} build file.
\item[\checkboxChecked] The {\small \verb+speech_event_test+} directory contains  no {\small \verb+package.xml+} manifest file since it is a package within the {\small \verb+unit_tests+} ROS node.
\item[\checkboxDashed] The {\small \verb+speech_event_test+} directory contains  a {\small \verb+speech_event_test_requirements.txt+} file with the dependencies (and their versions) required to be installed for proper functionality of the node.
...
This project is funded by the African Engineering and Technology
Network (Afretec)vInclusive Digital Transformation Research Grant
Programme.
...
\item[\checkboxChecked] The {\small \verb+speech_event_launch_robot.launch+} file launches the component being tested.
...
%===========================================================================
%================= D5.4.3 Robot Mission Interpreter - v1.0 =================
%===========================================================================

\section{D5.4.3 Robot Mission Interpreter - v1.0} 
...
%===========================================================================
%================= D5.4.3 Robot Mission Interpreter - v1.1 =================
%===========================================================================

\section{D5.4.3 Robot Mission Interpreter - v1.1} 
\subsection{Behavior Controller} 
%===========================================
\label{subsection:behaviour_controller}
...
\item[\checkboxChecked] The \textbf{behaviourController} directory has seven sub-directories:  {\small \verb+action+}, {\small \verb+config+}, {\small \verb+data+}, \\{\small \verb+include/behaviourController+},  {\small \verb+msg+}, {\small \verb+src+}, and {\small \verb+srv+}.

\item[\checkboxChecked] The  {\small \verb+action+} directory contains five files, named.
\begin{description}
\item[\checkboxChecked] {\small \verb+gestureExecutionPerformGesture.action+}
\item[\checkboxChecked] {\small \verb+robotNavigationSetGoal.action+}
\item[\checkboxChecked] {\small \verb+robotNavigationSetPose.action+}
\item[\checkboxChecked] {\small \verb+speechEventRecogniseSpeech.action+}
\item[\checkboxChecked] {\small \verb+textToSpeechSayText.action+}
\end{description}
...
\item[\checkboxChecked] The  {\small \verb+srv+} directory contains eight files, named:
\begin{description}
\item[\checkboxChecked] {\small \verb+animateBehaviorSetActivation.srv+}  
\item[\checkboxChecked] {\small \verb+gestureExecutionPerformGesture.srv+}  
\item[\checkboxChecked] {\small \verb+overtAttentionSetMode.srv+}  
...
\item[\checkboxChecked]  {\small \verb+behaviourControllerImplementation.cpp+}  
{\small \begin{verbatim}
/* behaviorControllerImplementation.cpp   Source code for the
 *  implementation of the robot mission node classes and other
 *  utility functions
 *
 * Author:  Tsegazeab Taye Tefferi, Carnegie Mellon University Africa
 * Email:   ttefferi@andrew.cmu.edu
...
\item[\checkboxChecked]  {\small \verb+cultureKnowledgeBaseImplementation.cpp+}  
{\small \begin{verbatim}
/* cultureKnowledgeBaseImplementation.cpp   Source code for the
 *  implementation of the culture knowledge base helper class:
...
\begin{verbatim}
 /* behaviorControllerApplication.cpp
 *
 * The component starts the 'Robot Mission Interpreter' ROS Node. This
 * node is the starting point for the robot to execute the mission
 * selected.
 * Though, this component exists as a standalone and can be started as
 * such, without the set of ROS nodes that are part of the CSSR4Afica
 * system architecture(see D3.1 System Architecture), it will not be
 * able function.
\end{verbatim}}
 ...
 * ----------------------|----------------------
 * scenarioSpecification | <the mission scenario to be interpreted>
 * verboseMode           | <true/false - enables/disables the
 *                          display of diagnostic messages>
 * asrEnabled            | <true/false> - enables/disables the
 *                          Automatic Speech Recognition. If
 *                          diabled, pepper's tablet will be
 *                          primary input method
 * audioDebugMode        | <true/false> - enables/disables the
 *                          audio for debugging
\end{verbatim}}
...
\item[\checkboxChecked]  The {\small \verb+behaviourController+} being tested writes short messages to the terminal during the start-up phase to
 indicate the state of the node:
\begin{verbatim}
behaviorController: startup
behaviorController: Scenario Specification: labTour
behaviorController: Mission Language: English
behaviorController: Audio Debug: Off
behaviorController: Checking Services...
behaviorController: All services available
behaviorController: Checking Topics...
behaviorController: All topics available
behaviorController: Checking Actions...
behaviorController: All actions available
behaviorController: Starting Misssion Execution ....
\end{verbatim}

\item[\checkboxChecked]  The {\small \verb+behaviourController+} being tested periodically (ideally every ten seconds, but behaviourController does this at the end of each tree traversal cycle) writes a short heartbeat message to
 the terminal to indicate the state of the node:
\begin{verbatim}
behaviorController: running
\end{verbatim}
...
\item[\checkboxChecked] The \textbf{behaviourControllerTest} directory has eight sub-directories:  {\small \verb+action+}, {\small \verb+config+}, {\small \verb+data+}, \\{\small \verb+include/behaviourControllerTest+}, {\small \verb+launch+}, {\small \verb+msg+}, {\small \verb+src+}, and {\small \verb+srv+}.
...
\item[\checkboxChecked] The  {\small \verb+launch+} directory contains two files, named as follows.
\begin{description}
\item[\checkboxChecked] {\small \verb+behaviourControllerTestLaunchRobot.launch+}  
\item[\checkboxChecked] {\small \verb+behaviourControllerTestLaunchTestHarness.launch+}
\end{description} 
...
\item[\checkboxChecked] {\small \verb+behaviourControllerTestDriver.cpp+}  
{\small \begin{verbatim}
/* behaviorControllerTestDriver.cpp   Source code for the simulated
 *  topics (drivers)
 *
 * Author:  Tsegazeab Taye Tefferi, Carnegie Mellon University Africa
 * Email:   ttefferi@andrew.cmu.edu
...
\item[\checkboxChecked]  {\small \verb+behaviourControllerTestImplementation.cpp+}  
{\small \begin{verbatim}
/* behaviorControllerTestImplementation.cpp   Source code for the methods
 *  used by behaviiorControllerTestApplication
 *
 * Author:  Tsegazeab Taye Tefferi, Carnegie Mellon University Africa
 * Email:   ttefferi@andrew.cmu.edu
 * Date:    April 25, 2025
...
\item[\checkboxChecked] {\small \verb+behaviourControllerTestStub.cpp+}  
{\small \begin{verbatim}
/* behaviorControllerTestStub.cpp   Source code for the simulated
 *  services (stubs)
 *
 * Author:  Tsegazeab Taye Tefferi, Carnegie Mellon University Africa
 * Email:   ttefferi@andrew.cmu.edu
...
\begin{verbatim}
 /* behaviorControllerTestApplication.cpp
 *
 * This module is responsible for running the tests on the
 * behaviorController ROS node
 * The tests will check if all the action and condition nodes of the
 * behaviorController are communicating and processing the data they
 * receive as expected
 *
\end{verbatim}}
 ...
 * Key                   |     Value 
 * --------------------- |     -------------------
 * failureRate           |      the rate at which service calls and
 *                              topics will provide a failed or not
 *                              successful response
 * arrivalRate           |      the rate at wich an event occurs (valid
 *                              only for the driver functions)
 * verboseMode           |      <true/false - enables/disables the display
...
%===========================================================================
%==================== D5.5.1.1 Gesture Execution - v1.0 ====================
%===========================================================================

\section{D5.5.1.1 Gesture Execution - v1.0} 
...
%===========================================================================
%==================== D5.5.1.1 Gesture Execution - v1.1 ====================
%===========================================================================

\section{D5.5.1.1 Gesture Execution - v1.1} 
\subsection{Gesture Execution} 
%===========================================
\label{subsection:gesture_execution}
The \textbf{Gesture Execution v1.1} software was submitted for integration on April 17th, 2026. The results indicate the software has successfully passed the integration process.
...
\item[\checkboxChecked] The \textbf{gestureExecution} directory has seven sub-directories: {\small \verb+action+}, {\small \verb+config+}, {\small \verb+data+}, \\{\small \verb+include/gestureExecution+}, {\small \verb+msg+}, {\small \verb+src+}, and {\small \verb+srv+}.

\item[\checkboxChecked] The  {\small \verb+action+} directory contains one file, named:

\begin{description}
\item[\checkboxChecked] {\small \verb+performGesture.action+}  
\end{description} 
...
{\small \begin{verbatim} 
 /* gestureExecutionApplication.cpp
 *
 * This module is responsible for hosting the service that executes
 * the gestures on the robot.
 * The module receives the gesture type, gesture ID, gesture duration,
 * bow/nod angle, and the location in the world to pay attention/point
 * to in x, y, z coordinates.
 * The module then executes the gesture based on the received parameters.
 *
 * The module supports the execution of deictic, iconic, symbolic, bow,
 * and nod gestures.
 * The iconic gestures currently supported are welcome and wave (goodbye)
 * gestures.
 *
 * The module also supports the selection of the implementation platform
 * (simulator or robot) and the interpolation type (linear or biological
 * motion).
 *
 * The module is implemented as a ROS service that receives the gesture
 * parameters and returns the status of the gesture execution.
 *
 * The gestures could either be executed using linear velocity interpolation
 * or a model of biological motion (minimum-jerk model).
 *
 * The module subscribes to the /sensor_msgs/joint_states topic to receive
 * the joint states of the robot.
 * The module also subscribes to the /robotLocalization/pose topic to receive
 * the coordinates of the robot in the world.
 *
 * The module is implemented in C++ and uses the ROS libraries for
...
...
 *
 * The clients can invoke the service by providing the gesture type,
 * gesture ID, gesture duration, bow_nod angle, and the location in
 * the world to pay attention/point to in x, y, z coordinates.
 * The service will execute the gesture based on the received parameters
 * and return the status of the gesture execution.
 *
 * Examples of calling the service is shown below:
 * ----- rosservice call /perform_gesture -- deictic 01 LEFT
 * PALM_UPWARDS 3000 25 3.6 2.5 0.82
 * This will execute a pointing gesture with a duration of 3000 ms,
 * and the location in the world to point to in x, y, z coordinates.
 *
 * ----- rosservice call /perform_gesture -- bow 01 '' '' 3000 25
 * 3.6 2.5 0.82
 * This will execute a pointing gesture with a duration of 3000 ms,
 * and bow at an angle of 45 degrees.
 *
\end{verbatim}}
...
\item[\checkboxChecked]  The {\small \verb+gestureExecution+} being tested writes short messages to the terminal during the start-up phase to
 indicate the state of the node:
\begin{verbatim}
gestureExecution: startup.
gestureExecution: configuration parameters:
                        Implementation platform		: robot, 
                        Interpolation type		    : biological,                 
                        Gestures Descriptors file	: gestureDescriptors.dat, 
                        Simulator Topics file		: simulatorTopics.dat,                 
                        Robot Topics file		    : pepperTopics.dat, 
                        Verbose Mode			    : false.
gestureExecution: subscribing to /joint_states...
gestureExecution: subscribed to /joint_states.
gestureExecution: creating a publisher for the velocity commands...
gestureExecution: created a publisher for the velocity commands.
gestureExecution: subscribing to robot pose topic...
gestureExecution: subscribed to robot pose topic.
gestureExecution: creating client for the /overtAttention/set_mode service...
gestureExecution: created client for the /overtAttention/set_mode service.
gestureExecution: advertising the /gestureExecution/perform_gesture service...
gestureExecution: advertised the /gestureExecution/perform_gesture service...
gestureExecution: action server started, waiting for goals...
gestureExecution: initialization complete...
\end{verbatim}
...
\item[\checkboxChecked] The  {\small \verb+launch+} directory contains three files, named as follows.
\begin{description}
\item[\checkboxChecked] {\small \verb+gestureExecutionTestLaunchRobot.launch+}  
\item[\checkboxDashed] {\small \verb+gestureExecutionTestLaunchSimulator.launch+}  
\item[\checkboxChecked] {\small \verb+gestureExecutionTestLaunchTestHarness.launch+}
\end{description} 
...
\begin{verbatim}
 /* gestureExecutionTestApplication.cpp
 *
 * This module is responsible for running the tests on the gesture
 * execution node.
 * The tests are run using Google Test and the results are written
 * to a file. 
 * The module tests the iconic, deictic, bow, nod, and symbolic
 * gestures.
 *
\end{verbatim}}
...
\item[\checkboxDashed] A unit test application named {\small \verb+gestureExecutionTestLaunchSimulator.launch+} is provided in the {\small \verb+launch+} directory. 
...
\item[\checkboxChecked]  The {\small \verb+gestureExecutionTest+} being tested writes short messages to the terminal during the start-up phase to
 indicate the state of the node:
\begin{verbatim}
gestureExecutionTest: startup.
gestureExecutionTest: running on the robot platform...
gestureExecutionTest: selected interface: service
gestureExecutionTest: /gestureExecution/perform_gesture service
                        available.
gestureExecutionTest: creating a publisher for the speech commands...
gestureExecutionTest: waiting for /speech topic to be available...
gestureExecutionTest: created publisher for /speech.
gestureExecutionTest: Creating the test report file '/home/user/
                        workspace/pepper_rob_ws/src/cssr4africa/
                        unit_tests/gestureExecutionTest/data/
                        gestureExecutionTestOutput.dat'...
gestureExecutionTest: Test report file '/home/user/workspace/
                        pepper_rob_ws/src/cssr4africa/unit_tests/
                        gestureExecutionTest/data/
                        gestureExecutionTestOutput.dat' created.
gestureExecutionTest: ready.
\end{verbatim}
...
%===========================================================================
%========== D5.5.2.4 Integrated Text to Speech Conversion - v1.0 ===========
%===========================================================================

\section{D5.5.2.4 Integrated Text to Speech Conversion - v1.0}
...
%===========================================================================
%========== D5.5.2.4 Integrated Text to Speech Conversion - v1.1 ===========
%===========================================================================

\section{D5.5.2.4 Integrated Text to Speech Conversion - v1.1}
...
\item[\checkboxChecked] The \textbf{text\_to\_speech} directory has six sub-directories: {\small \verb+action+}, {\small \verb+config+}, {\small \verb+data+}, {\small \verb+model+}, {\small \verb+src+}, and {\small \verb+srv+}.

\item[\checkboxChecked] The  {\small \verb+action+} directory contains one file, named as follows.
\begin{description}
\item[\checkboxChecked] {\small  \texttt{TTS.action}}
\end{description}
...
\item[\checkboxChecked] The  {\small \texttt{model}} directory contains two sub-directories.
\begin{description} 
\item[\checkboxChecked] {\small \texttt{en\_model}}
\item[\checkboxChecked] {\small \texttt{rw\_model}}
\end{description}

\item[\checkboxChecked] The  {\small \verb+src+} directory contains four source files, named as follows.
\begin{description}
\item[\checkboxChecked] {\small \verb+__init__.py+}
\item[\checkboxChecked] {\small \verb+send_and_play_audio.py+}
\item[\checkboxChecked] {\small \verb+text_to_speech_application.py+}
\item[\checkboxChecked]  {\small \verb+text_to_speech_implementation.py+}
\end{description}
...
\item[\checkboxChecked] The  {\small \verb+srv+} directory contains one file, named as follows.
\begin{description}
\item[\checkboxChecked] {\small \verb+TTS.srv+}
\end{description}
...
This ROS application node provides text-to-speech (TTS) services and
actions supporting both Kinyarwanda and English languages.
The node integrates with Pepper robot's audio system and a local host
playback path, using a fine-tuned YourTTS
model for Kinyarwanda and the XTTS v2 model for English. It exposes a
ROS service and/or action interface that
accept text messages and language specifications, then generate and play
...
> Parameters
    ...
    > Configuration File Parameters
        ...
        - port: Communication port for robot connection
        - useCuda: (True/False)
        - englishSpeakerWav: Optional speaker reference WAV for English
            synthesis
\end{verbatim}}
...
\begin{verbatim}
> Output Data Files
    - Temporary .wav files: Generated audio files for speech synthesis
        (auto-deleted)
    - ROS log files: Node operation logs in ~/.ros/log/
\end{verbatim}}
...
{\small
\begin{verbatim}
textToSpeech: startup.
textToSpeech: service advertised at /textToSpeech/say_text
textToSpeech: action server started at /textToSpeech/say_text
\end{verbatim}
} 
...
\item[\checkboxDashed] Unit test instructions are provided in a file named {\small \verb+README.md+} in the {\small \verb+text_to_speech+} directory.

\begin{description}

\item[\checkboxDashed] The instructions  explain how the  communication and computation functionality are validated by describing the (sink) output data that will be produced from the (source) input data.  

\item[\checkboxDashed] The instructions  explain how the  configuration functionality is validated by describing what changes in behaviour will occur if the values for the component parameters in the component configuration ({\small \verb+text_to_speech_configuration.ini+}) file are altered.
...
"""
text_to_speech_test_application.py - ROS-based integration test application for
validating Text-to-Speech (TTS) service and action server implementation
...
\begin{verbatim}
> text_to_speech_test_application.py - ROS-based integration test application
for validating Text-to-Speech (TTS) service and action server implementation.

This application serves as a comprehensive testing framework for validating
the functionality and integration of a Text-to-Speech (TTS) node within a
ROS environment.
The primary purpose is to ensure that the TTS implementation correctly
processes text input in both English and Kinyarwanda languages and produces
appropriate audio output on pepper robot. Tests cover both the ROS service
interface and the ROS action server interface. Each interface is tested
independently so that the suite still runs when only one is enabled via the
...
\begin{verbatim}
> Libraries
    - rospy: ROS Python client library for node initialization and
    ...
    - text_to_speech_test_implementation: Custom module containing:
        ...
        - print_success, print_warning, print_error, print_info,
            print_header: Colored output functions
\end{verbatim}}
...
\begin{verbatim}
> Actions Invoked
    - /textToSpeech/say_text (cssr_system/TTSAction): Text-to-speech action
        server with feedback and result
\end{verbatim}}
...
{\small
\begin{verbatim}
textToSpeechTest: startup.
textToSpeechTest: connecting to /textToSpeech/say_text (service and/or action).
\end{verbatim}
} 
...
\item[\checkboxChecked] The instructions  explain how the  configuration functionality is validated by describing what changes in behaviour will occur if the values for the component parameters in the component configuration ({\small \verb+text_to_speech_test_configuration.ini+}) file are altered.
...
%===========================================================================
%===================== D5.5.4 Robot Navigation - v1.1 ======================
%===========================================================================

% \section{D5.5.4 Robot Navigation - v1.1}

% The \textbf{Robot Navigation v1.1} software was submitted for integration on April 7th, 2026. The results indicate the software has successfully passed the integration process. 
...
% \item[\checkboxChecked] The \textbf{robotNavigation} directory has eight sub-directories: {\small \verb+action+}, {\small \verb+config+}, {\small \verb+data+}, \\{\small \verb+include/robotNavigation+}, {\small \verb+msg+}, {\small \verb+slam+}, {\small \verb+src+}, and {\small \verb+srv+}.

% \item[\checkboxChecked] The  {\small \verb+action+} directory contains two files, named as follows.

% \begin{description}
% \item[\checkboxChecked] {\small \verb+setGoal.action+}
% \item[\checkboxChecked] {\small \verb+setPose.action+}
% \end{description}
...
%         \item[\checkboxChecked] {\small \texttt{parameters230.dat}}
%         \item[\checkboxChecked] {\small \texttt{parameters240.dat}}
%         \item[\checkboxChecked] {\small \texttt{configurationSpaceMap.png}}
%         \item[\checkboxChecked] {\small \texttt{environmentMap.png}}
%         \item[\checkboxChecked] The topics file {\small \texttt{pepperTopics.dat}} contains the key-value pairs that set the topic names required by the component.
%         \item[\checkboxChecked] Each key-value pair of the {\small \texttt{pepperTopics.dat}} file is written on a separate line.
%         \end{description}
%     \item The output files are named as follows.
%         \begin{description}
%             \item[\checkboxChecked] {\small \texttt{robotPose.dat}}
%             \item[\checkboxChecked] {\small \texttt{configMapWaypoints<algorithm>.png}} where the placeholder {\small \texttt{<algorithm>}} can be one of {\small \verb+AStar+}, {\small \verb+BFS+}, {\small \verb+DFS+}, or {\small \verb+Dijkstra+}.
%             \item[\checkboxChecked] {\small \texttt{environmentMapWaypoints<algorithm>.png}} where the placeholder {\small \texttt{<algorithm>}} can be one of {\small \verb+AStar+}, {\small \verb+BFS+}, {\small \verb+DFS+}, or {\small \verb+Dijkstra+}.
%         \end{description}
% \end{itemize}
...
% \item[\checkboxChecked] The  {\small \verb+slam+} directory contains four sub-directories with a total of twelve files, named as follows.
% \begin{description}
% \item[\checkboxChecked] {\small \verb+config/+}
%     \begin{description}
%     \item[\checkboxChecked] {\small \verb+config/pepper.rviz+}
%     \end{description}
% \item[\checkboxChecked] {\small \verb+launch/+}
%     \begin{description}
%     \item[\checkboxChecked]  {\small \verb+launch/includes/amcl/asus_xtion_pro_amcl.launch.xml+}
%     \item[\checkboxChecked]  {\small \verb+launch/navigation.launch+}
%     \end{description}
% \item[\checkboxChecked] {\small \verb+maps/+}
%     \begin{description}
%     \item[\checkboxChecked]  {\small \verb+maps/environmentMap.pgm+}
%     \item[\checkboxChecked]  {\small \verb+maps/environmentMap.yaml+}
%     \end{description}
% \item[\checkboxChecked] {\small \verb+param/+}
%     \begin{description}
%     \item[\checkboxChecked]  {\small \verb+param/base_local_planner_params.yaml+}
%     \item[\checkboxChecked]  {\small \verb+param/costmap_common_params.yaml+}
%     \item[\checkboxChecked]  {\small \verb+param/dummy.yaml+}
%     \item[\checkboxChecked]  {\small \verb+param/global_costmap_params.yaml+}
%     \item[\checkboxChecked]  {\small \verb+param/global_planner_params.yaml+}
%     \item[\checkboxChecked]  {\small \verb+param/local_costmap_params.yaml+}
%     \item[\checkboxChecked]  {\small \verb+param/move_base_params.yaml+}
%     \end{description}
% \end{description}
...
% \item[\checkboxChecked] The  {\small \verb+srv+} directory contains one file, named as follows.
% \begin{description}
% \item[\checkboxChecked] {\small \verb+setGoal.srv+}
% \end{description}
...
% {\small
% \begin{verbatim}
% robotNavigation: startup.
% robotNavigation: Goal Service Server Ready to receive requests.
% robotNavigation: Pose Service Server Ready to receive requests.
% robotNavigation: Goal Action Server Ready to receive requests.
% robotNavigation: Pose Action Server Ready to receive requests.
% robotNavigation: Environment Map File: environmentMap.png
% robotNavigation: Configuration Map File: configurationSpaceMap.png
% robotNavigation: Path Planning Algorithm: A*
% robotNavigation: Social Distance Mode: true
% robotNavigation: Robot Topics: pepperTopics.dat
% robotNavigation: Topics Filename: pepperTopics.dat
% robotNavigation: Verbose Mode: false
% robotNavigation: Robot Type: old
% robotNavigation: Navigation Mode: CAD
% robotNavigation: Social distance enabled - passing distance value: 100.0 cm
% robotNavigation: Wheels topic: /cmd_vel
% robotNavigation: Using parameters for old robot (parameters230.dat) from configuration
% robotNavigation: Waiting for /robotLocalization/pose topic to become available...
% robotNavigation: /robotLocalization/pose topic found, Subscribing...
% robotNavigation: Successfully subscribed to /robotLocalization/pose
% robotNavigation: POSITION_TOLERANCE:        0.30
% robotNavigation: POSITION_TOLERANCE_GOAL:   0.20
% robotNavigation: ANGLE_TOLERANCE_ORIENTING: 0.10
% robotNavigation: ANGLE_TOLERANCE_GOING:     0.20
% robotNavigation: POSITION_GAIN_DQ:          0.50
% robotNavigation: ANGLE_GAIN_DQ:             0.50
% robotNavigation: POSITION_GAIN_MIMO:        0.35
% robotNavigation: ANGLE_GAIN_MIMO:           0.30
% robotNavigation: MIN_LINEAR_VELOCITY:       0.03
% robotNavigation: MAX_LINEAR_VELOCITY:       0.30
% robotNavigation: MIN_ANGULAR_VELOCITY:      0.05
% robotNavigation: MAX_ANGULAR_VELOCITY:      1.00
% robotNavigation: CLEARANCE:                 0.30
% robotNavigation: SHORTEST_PATH_ALGORITHM    0
% robotNavigation: ROBOT_AVAILABLE            1
% \end{verbatim}
% } 
...
%         \begin{description} 
%         \item[\checkboxChecked] {\small \texttt{pepperTopics.dat}}
%         \item[\checkboxChecked] {\small \texttt{actionNavigationInput.dat}}
%         \item[\checkboxChecked] {\small \texttt{astarAlgorithmInput.dat}}
%         \item[\checkboxChecked] {\small \texttt{bfsAlgorithmInput.dat}}
%         \item[\checkboxChecked] {\small \texttt{dijkstraAlgorithmInput.dat}}
%         \item[\checkboxChecked] {\small \texttt{boundaryTestInput.dat}}
...
% \item[\checkboxChecked] {\small \verb+robotNavigationTestImplementation.cpp+}
% {\scriptsize \begin{verbatim}
% /* robotNavigationTestImplementation.cpp - robot navigation functions that can be used by
% * the unit test ROS Node
% *
% * Author:  Birhanu Shimelis Girma, Carnegie Mellon University Africa
% * Email:   bgirmash@andrew.cmu.edu
% * Date:    June 05, 2025
...
% \item[\checkboxChecked] {\small \verb+robotNavigationTestInterface.cpp+}
% {\scriptsize \begin{verbatim}
% /* robotNavigationTestInterface.h - robot navigation unit test interfaceing and
% * library importing that help the unit test ROS Node.
% *
% * Author:  Birhanu Shimelis Girma, Carnegie Mellon University Africa
% * Email:   bgirmash@andrew.cmu.edu
% * Date:    June 05, 2025
...
% \begin{verbatim}
% robotNavigationTest: start-up.
% robotNavigationTest: /robotNavigation/set_goal service available.
% robotNavigationTest: /robotLocalization/set_pose service available.
% robotNavigationTest: /robotNavigation/set_pose service available.
% robotNavigationTest: /robotNavigation/set_goal action not yet available -
%     action tests may need to wait
% robotNavigationTest: /robotNavigation/set_pose action not yet available -
%     setPose action tests may need to wait
% robotNavigationTest: Creating the test report file '/home/user/workspace/
%     pepper_rob_ws/src/cssr4africa/unit_tests/robotNavigationTest/data/
%     robotNavigationTestOutput.dat'...
% robotNavigationTest: Test report file '/home/user/workspace/pepper_rob_ws/
%     src/cssr4africa/unit_tests/robotNavigationTest/data/
%     robotNavigationTestOutput.dat' created.
% robotNavigationTest: Loaded environment map from '/home/user/workspace/
%     pepper_rob_ws/src/cssr4africa/cssr_system/robotNavigation/data/
%     environmentMap.png'
% robotNavigationTest: Loaded configuration map from '/home/user/workspace/
%     pepper_rob_ws/src/cssr4africa/cssr_system/robotNavigation/data/
%     configurationSpaceMap.png'
% robotNavigationTest: Test Configuration:
% robotNavigationTest: Path Planning BFS Test: enabled
% robotNavigationTest: Path Planning Dijkstra Test: enabled
% robotNavigationTest: Path Planning A* Test: enabled
% robotNavigationTest: Service Tests: enabled
% robotNavigationTest: Boundary Tests: enabled
% robotNavigationTest: Action Tests: enabled
% robotNavigationTest: Action Feedback Tests: enabled
% robotNavigationTest: Action Preemption Tests: enabled
% robotNavigationTest: Set Pose Tests: enabled
% robotNavigationTest: ready.
% \end{verbatim}
% } 
...
\item [Version 1.4]~\\
The following updated ROS nodes (v1.1) were integrated into the main CSSR4Africa repository, and their integration results included in this document: speech event, robot mission interpreter, gesture execution, integrated text to speech conversion. \\
Clifford Onyonka. \\
19 June 2026.
