...
\hline
{\footnotesize \verb+gestureArm+} 	                 & {\footnotesize 2-8 } \vspace{-1mm}\\
...
\multicolumn{2}{|c|}{{\footnotesize Hand Gesture}} \\
\hline
{\footnotesize \verb+gestureArm+} 	                 & {\footnotesize 2-8} \vspace{-1.01mm}\\
...
\hline
{\footnotesize \verb+gestureArm+} 	                 & {\footnotesize \verb++  Use the arm closest to the object when pointing} \vspace{-1.01mm}\\
...
\hline
{\footnotesize \verb+gestureArm+} 	                 & {\footnotesize \verb+EITHER+} & {\footnotesize  }\vspace{-1.01mm}\\
...
{\footnotesize \verb+utilityPhraseEnglish8+}             & {\footnotesize \verb+PHRASE+ } \vspace{-1.5mm}  \\
{\footnotesize \verb+utilityPhraseKinyarwanda8+}    & {\footnotesize \verb+PHRASE+}  \vspace{-1.5mm} \\
{\footnotesize \verb+utilityPhraseIsiZulu8+}             & {\footnotesize \verb+UNDEFINED+ }\vspace{-1.5mm} \\
...
{\footnotesize \verb+gestureArm+} 	                                          & {\footnotesize \verb+EITHER+} \vspace{-1.5mm}\\
...
%\begin{center}
\vspace{-3mm}
\begin{tabular}{p{0.3\linewidth} p{0.68\linewidth}}
\footnotesize\texttt{utilityPhraseEnglish1} &
\footnotesize\texttt{Hello everyone! Welcome to the AI and Robotics lab, here at Carnegie Mellon University Africa. My name is Pepper. I am what is called a Humanoid Robot. That means I was designed to look, move and act like you, humans! For today, I will be your tour guide.} \\

\footnotesize\texttt{utilityPhraseKinyarwanda1} &
\footnotesize\texttt{Muraho mwese! Murakaza neza muri laboratwari ya AI na Robotika hano muri Carnegie Mellon University Africa. Nitwa Pepper. Ndi icyo bita robo imeze nk’umuntu. Ibi bivuze ko naremewe gusa, kugenda no gukora nkamwe, abantu! Uyu munsi ndababera umuyobozi w’urugendo.} \\

\footnotesize\texttt{utilityPhraseEnglish2} &
\footnotesize\texttt{Stand back and watch, as I go around the lab and explain some of the things we do here.} \\

\footnotesize\texttt{utilityPhraseKinyarwanda2} &
\footnotesize\texttt{Nimwigire inyuma mwitegereze, mu gihe nzenguruka muri laboratwari nsobanura bimwe mu byo dukora hano.} \\

\footnotesize\texttt{utilityPhraseEnglish3} &
\footnotesize\texttt{Now, we move on to the best part of the tour. The star of the main project done here at the lab.} \\

\footnotesize\texttt{utilityPhraseKinyarwanda3} &
\footnotesize\texttt{Ubu noneho tujye ku gice cy’ingenzi cy’urugendo. Icy’ingenzi cyane mu mushinga ukorerwa hano muri laboratwari.} \\

\footnotesize\texttt{utilityPhraseEnglish4} &
\footnotesize\texttt{That marks the last item on the tour. If you have any further questions, please ask my colleagues here.} \\

\footnotesize\texttt{utilityPhraseKinyarwanda4} &
\footnotesize\texttt{Ibyo birarangiza urugendo rwacu. Niba mufite ibindi bibazo, mwabaza abo dukorana hano.} \\



\footnotesize\texttt{utilityPhraseEnglish5} &
\footnotesize\texttt{That is it from me. I hope you enjoyed the tour of the AI \& Robotics Lab here at Carnegie Mellon University Africa.} \\

\footnotesize\texttt{utilityPhraseKinyarwanda5} &
\footnotesize\texttt{Ni ibyo nababwiraga. Nizeye ko mwishimiye urugendo rwo muri laboratwari ya AI na Robotika hano muri Carnegie Mellon University Africa.} \\

\footnotesize\texttt{utilityPhraseEnglish6} &
\footnotesize\texttt{Hi there. Would you like a tour of the lab?} \\

\footnotesize\texttt{utilityPhraseKinyarwanda6} &
\footnotesize\texttt{Muraho. Wakwifuza gutemberezwa muri laboratwari?} \\

\footnotesize\texttt{utilityPhraseEnglish7} &
\footnotesize\texttt{No problem. Perhaps we can do it another time.} \\

\footnotesize\texttt{utilityPhraseKinyarwanda7} &
\footnotesize\texttt{Nta kibazo. Ahari twabikora ikindi gihe.} \\

\footnotesize\texttt{utilityPhraseEnglish8} &
\footnotesize\texttt{I Hope to meet with you again soon. I will be right here, ready for our next adventure. See you soon!} \\

\footnotesize\texttt{utilityPhraseKinyarwanda8} &
\footnotesize\texttt{Nizeye ko tuzongera guhura vuba. Nzaba nkiri hano, niteguye urugendo rwacu rutaha. Tuzabonana vuba!} \\
...
\item [Version 2.2]~\\
Added references to arm selection for ``deictic gestures'' \\
Added {\small \tt gestureArm} as a key in the cultural knowledge base \\
Updated the ``Utility Key Phrases''` \\
Tsegazeab Tefferi.\\
15 May 2026.   \\  
